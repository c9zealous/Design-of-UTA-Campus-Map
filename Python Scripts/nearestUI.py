...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.label_3.setGeometry(QtCore.QRect(200, 150, 150, 16))
        self.label_3.setObjectName(_fromUtf8("label_3"))
        self.submitButton = QtGui.QPushButton(Dialog)
        self.submitButton.setGeometry(QtCore.QRect(220, 220, 93, 28))
        self.submitButton.setObjectName(_fromUtf8("submitButton"))
        self.submitButton.clicked.connect(lambda : self.nearest(comboBox.currentText(),comboBox2.currentText(),comboBox3.currentText()))
        ...
        comboBox3.setGeometry(QtCore.QRect(170, 180, 200, 28))
    ...
    def retranslateUi(self, Dialog):
        Dialog.setWindowTitle(_translate("Dialog", "Nearest Neighbor", None))
    ...
    def nearest(self,building, gtype, distance):
        conn = sqlite3.connect("C:\Users\Shubham\Desktop\DATABASE_SPATIALITE\DBSPatiaLite.sqlite")
        c = conn.cursor()
        conn.enable_load_extension(True)
        c.execute("select load_extension('mod_spatialite')")
